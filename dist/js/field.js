...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-nova-tinymce5-editor', __webpack_require__(4));
  Vue.component('detail-nova-tinymce5-editor', __webpack_require__(7));
  Vue.component('form-nova-tinymce5-editor', __webpack_require__(10));
  Vue.component('media-picker-nova-tinymce5-editor', __webpack_require__(20));
  Vue.component('image-block-mt', __webpack_require__(23));
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    computed: {
        ...
        editorConfig: function editorConfig() {
            ...
            var editorConfig = this.editorConfigInit;
            var self = this;
    ...
    methods: {
        ...
        handleMediaPicker: function handleMediaPicker(val) {
            this.showMediaPicker = val;
        },
        handleImageChoose: function handleImageChoose(imgs) {
            console.log(imgs);
...
var render = function() {
  ...
  return _c(
    ...
    [
      ...
      _vm._v(" "),
      _vm.showMediaPicker
        ? _c("media-picker-nova-tinymce5-editor", {
            attrs: { field: _vm.field },
            on: {
              choose: _vm.handleImageChoose,
              close: function($event) {
                return _vm.handleMediaPicker(false)
              }
            }
          })
        : _vm._e()
...
Component.options.__file = "resources/js/components/addons/media/ImagePicker.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-077b296d", Component.options)
  } else {
    hotAPI.reload("data-v-077b296d", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    getMedia: function getMedia() {
      ...
      var url = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "/nova-vendor/nova-media-tinymce/get-images";

      this.imagesIsLoading = true;
      Nova.request().get(url).then(function (res) {
        _this.images = res.data.data;
        _this.initialLoading = false;
        _this.imagesIsLoading = false;

        _this.pagination = res.data.links;
      }).catch(function (e) {
        _this.$toasted.show("Unable to load images !", { type: 'error' });
      });
    },
    ...
    searchWhenTyping: function searchWhenTyping() {
    ...
    searchImages: function searchImages() {
      ...
      Nova.request().get('/nova-vendor/nova-media-tinymce/search-images/' + this.searchQuery).then(function (res) {
        _this2.images = res.data;
        _this2.imagesIsLoading = false;

        _this2.pagination = [];
      }).catch(function (e) {
        _this2.$toasted.show("Unable to search images !", { type: 'error' });
      });
    },
    handleFileUpload: function handleFileUpload() {
      ...
      Nova.request().post('/nova-vendor/nova-media-tinymce/upload-image', formData, {
        ...
        _this3.images.unshift(res.data);
        _this3.$toasted.show("Sucesfuly uploaded !", { type: 'success' });
        _this3.imagesIsLoading = false;
      }).catch(function (e) {
        _this3.$toasted.show("Unable to upload image !", { type: 'error' });
        _this3.imagesIsLoading = false;
      });
    }
  }
...
var render = function() {
  ...
  return _c(
    "modal",
    { staticClass: "select-text", on: { "modal-close": _vm.handleClose } },
    [
      _c(
        "loading-card",
        ...
        [
          _c(
            "card",
            { staticClass: "w-choose-existing-media overflow-auto h-100" },
            [
              _c(
                "h4",
                {
                  staticClass:
                    "text-90 font-normal text-2xl flex-no-shrink px-8 pt-6"
                },
                [_vm._v("\n          Select Media\n        ")]
              ),
              _vm._v(" "),
              _c("div", { staticClass: "bg-30 px-8 py-4 mt-6 flex" }, [
                _c(
                  "form",
                  {
                    on: {
                      submit: function($event) {
                        ...
                        return _vm.searchImages.apply(null, arguments)
                      }
                    }
                  },
                  [
                    _c("div", { staticClass: "relative h-9 flex-no-shrink" }, [
                      _c(
                        "svg",
                        {
                          staticClass:
              ...
              _vm._v(" "),
              _c("loading-view", { attrs: { loading: _vm.imagesIsLoading } }, [
              ...
              _c(
                ...
                [
                  _vm._l(_vm.pagination, function(page, k) {
                    return _c("button", {
                      key: k,
                      class: page.active
                        ? "btn text-80 font-normal h-9 px-3 mr-3 btn-link pagination-active"
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-077b296d", module.exports)
  }
}
...
/* scopeId */
var __vue_scopeId__ = "data-v-70b7be7e"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __vue_script__,
...
Component.options.__file = "resources/js/components/addons/media/ImageBlock.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-70b7be7e", Component.options)
  } else {
    hotAPI.reload("data-v-70b7be7e", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var update = __webpack_require__(27)("f5d84f02", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-70b7be7e\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./ImageBlock.vue", function() {
     var newContent = require("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-70b7be7e\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./ImageBlock.vue");
...
var render = function() {
  ...
  return _c(
    "div",
    {
      staticClass: "nml-item relative mb-2 cursor-pointer",
      attrs: { title: _vm.image.name },
      on: {
        click: function($event) {
          return _vm.$emit("choose", _vm.image)
        }
      }
    },
    [
      _c(
        "div",
        {
          staticClass: "icon rounded-lg shadow-md nml-icon-image",
          style: 'background-image: url("' + _vm.image.preview_url + '")'
        },
        [
          _c("div", { staticClass: "img-text" }, [
            _vm._v("\n      " + _vm._s(_vm.image.name) + " "),
            _c("br"),
            _vm._v(" (" + _vm._s(_vm.image.size) + ")\n    ")
          ])
        ]
      ),
      _vm._v(" "),
      _c("div", { staticClass: "title truncate" }, [
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-70b7be7e", module.exports)
  }
}
